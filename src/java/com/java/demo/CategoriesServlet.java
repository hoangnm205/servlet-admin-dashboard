...
import com.java.demo.logic.CategoryModel;
...
public class CategoriesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int limit = 10; //  cố định = 10
            int page = 1;
            String queryString = request.getQueryString();
            if (queryString != null) {
                page = Integer.parseInt(queryString.split("=")[1]);
            }
            List<Category> cates = model.list(limit, page); // limit vs page
            
            // tính tổng số trang
            int totalRecords = model.count();
            int total = (int) Math.ceil((double)totalRecords / (double)limit);
